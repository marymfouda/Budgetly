        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MonthlyIncomeTarget = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentSavedAmount = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BudgetLimits_BudgetCategories_BudgetCategoryId",
                        column: x => x.BudgetCategoryId,
                        principalTable: "BudgetCategories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 2, "bi-bag", "Shopping" },
                    { 3, "bi-receipt", "Bills" },
                    { 4, "bi-car-front", "Transportation" },
                    { 5, "bi-controller", "Entertainment" },
                    { 6, "bi-heart-pulse", "Health" },
                    { 7, "bi-book", "Education" },
                    { 8, "bi-three-dots", "Other" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BudgetLimits_BudgetCategoryId",
                table: "BudgetLimits",
